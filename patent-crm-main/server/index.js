...
const registerRoutes = () => {
  ...
  // SALARIES
  try {
    console.log('✅ /api/salaries routeri ro\'yxatdan o\'tkazilmoqda...');
    app.use('/api/salaries', require('./routes/salaries'));
    console.log('✅ /api/salaries routeri muvaffaqiyatli ro\'yxatdan o\'tkazildi');
  } catch (error) {
    console.error('⛔️ /api/salaries routerini yuklashda xatolik:', error.message);
  }
  
  // FINANCIAL
  try {
    console.log('✅ /api/financial routeri ro\'yxatdan o\'tkazilmoqda...');
    app.use('/api/financial', require('./routes/financial'));
    console.log('✅ /api/financial routeri muvaffaqiyatli ro\'yxatdan o\'tkazildi');
  } catch (error) {
    console.error('⛔️ /api/financial routerini yuklashda xatolik:', error.message);
  }
};
