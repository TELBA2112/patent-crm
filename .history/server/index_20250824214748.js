...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      // Login test endpointini ko'rsatish
      console.log('🔑 Login endpointi: http://localhost:${PORT}/api/auth/login');
      console.log('POST ma\'lumot namunasi:');
    ...
    console.error('\n❌ MongoDB ga ulanishda xatolik:', err.message);
    process.exit(1);
  }
};
