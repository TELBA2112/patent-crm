...
router.post('/', authenticate, async (req, res) => {
  ...
  try {
    // --- personType VALIDATION (muammo shu joydan kelib chiqmoqda) ---
    ...
    // Agar mongoose validation error bo'lsa, aniqroq qaytarish
...
router.put('/:id', authenticate, async (req, res) => {
  ...
  try {
    ...
    // Agar personType kelgan bo'lsa, tekshirish
