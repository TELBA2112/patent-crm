...
module.exports = function(app) {
  ...
  app.post('/api/job-actions/:jobId/send-for-review', authenticate, async (req, res) => {
    try {
  ...
  app.post('/api/job-actions/:jobId/review-brand', authenticate, async (req, res) => {
    try {
      const { jobId } = req.params;
  ...
  app.post('/api/job-actions/:jobId/submit-documents', authenticate, async (req, res) => {
    try {
      const { jobId } = req.params;
  ...
  app.get('/api/job-actions/:jobId/power-of-attorney', authenticate, async (req, res) => {
};
