...
// Brendni tekshiruvchiga yuborish (MKTU sinflarisiz)
...
// Hujjatlarni yuborish (MKTU sinflarisiz)
...
// Ishonchnoma uchun ma'lumotlarni yuklash (MKTU sinflarisiz)
router.get('/:jobId/power-of-attorney', auth, async (req, res) => {
  try {
    ...
    console.error('Ishonchnoma ma\'lumotlari xatosi:', err);
    return res.status(500).json({ message: 'Server xatosi', error: err.message });
  }
});
