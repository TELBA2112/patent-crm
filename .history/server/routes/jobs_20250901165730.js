...
// Fallback for MKTU class updates for compatibility
// This ensures the API works regardless of which endpoint the client calls
router.post('/:id/update-mktu-classes', auth, async (req, res) => {
  try {
    ...
    console.log('[Fallback] MKTU sinflari yangilanmoqda:', { jobId: id, classes, userId });
    ...
    console.error('[Fallback] MKTU sinflarini yangilashda xatolik:', err);
