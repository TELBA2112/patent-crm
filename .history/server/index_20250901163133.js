...
const jobActionsRoutes = require('./routes/jobActions'); // Make sure this is imported
const powerOfAttorneyRoutes = require('./routes/powerOfAttorneyRoutes'); // Make sure this is imported
...
const registerRoutes = () => {
  ...
  app.use('/api/job-actions', jobActionsRoutes); // Make sure this is registered

  console.log('✅ /api/power-of-attorney routeri ro\'yxatdan o\'tkazildi');
  app.use('/api/power-of-attorney', powerOfAttorneyRoutes); // Make sure this is registered
};
