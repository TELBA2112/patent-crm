...
// (Removed duplicate startServer definition and invocation)
...
mongoose.connect(process.env.MONGO_URI, {
  ...
  .catch(err => {
    ...
    console.error('Iltimos quyidagilarni tekshiring:');
    console.error('1. MongoDB servis ishlamoqda');
    console.error('2. MONGO_URI to\'g\'ri ko\'rsatilgan (.env faylida)');
    console.error('3. MongoDB uchun barcha kerakli portlar ochiq');
    console.error('\nXatolik tafsilotlari:', err);
    process.exit(1);
  });
