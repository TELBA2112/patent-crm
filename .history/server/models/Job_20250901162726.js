  ...
  classes: {
    ...
    validate: {
      validator: function(classes) {
        // Make sure all elements are numbers and between 1-45
        return classes.every(cls => Number.isInteger(cls) && cls >= 1 && cls <= 45);
      },
      message: "MKTU sinflari 1 dan 45 gacha bo'lgan butun sonlar bo'lishi kerak"
    }
  },
  createdAt: {
    type: Date,
