...
try {
  ...
  console.error('Message modelini yuklashda xatolik:', e.message);
}
...
try {
  ...
  console.error('Notification modelini yuklashda xatolik:', e.message);
}

// Salary modelini import qilish
try {
  require('./Salary');
  console.log('Salary modeli muvaffaqiyatli yuklandi');
} catch (e) {
  console.error('Salary modelini yuklashda xatolik:', e.message);
}

// FinancialTransaction modelini import qilish
try {
  require('./FinancialTransaction');
  console.log('FinancialTransaction modeli muvaffaqiyatli yuklandi');
} catch (e) {
  console.error('FinancialTransaction modelini yuklashda xatolik:', e.message);
}
