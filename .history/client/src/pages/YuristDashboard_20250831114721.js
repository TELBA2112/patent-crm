...
function YuristDashboard({ onLogout }) {
  ...
  const renderModal = () => {
    ...
    const hasPowerOfAttorney = documents.some(d => d.type === 'power-of-attorney');
        ...
        <div className="modal-content">
          ...
          <div className="task-content-container">
            ...
            <div className="task-documents-section">
              ...
              {/* Ishonchnoma mavjud bo'lsa - Yangilangan: har qanday holatdagi ishlarda ishonchnoma ko'rinadi */}
              {hasPowerOfAttorney ? (
                <div className="power-of-attorney-block">
                  ...
                  <div className="power-of-attorney-content">
                    ...
                    {/* Ishonchnomani ko'rish tugmasini qo'shamiz */}
  ...
  const renderSidebar = () => (
    <div className="yurist-sidebar">
      ...
      <div className="sidebar-links">
        <div 
          className={`sidebar-link ${currentSection === 'yangi' ? 'active' : ''}`} 
          onClick={() => setCurrentSection('yangi')}
        >
          🟢 Yangi ishlar
        </div>
        <div 
          className={`sidebar-link ${currentSection === 'jarayonda' ? 'active' : ''}`} 
          onClick={() => setCurrentSection('jarayonda')}
        >
          🟡 Jarayondagi ishlar
        </div>
        <div 
          className={`sidebar-link ${currentSection === 'tugatilgan' ? 'active' : ''}`} 
          onClick={() => setCurrentSection('tugatilgan')}
        >
          ✅ Tugatilgan ishlar
        </div>
        <div 
          className={`sidebar-link ${currentSection === 'hisobot' ? 'active' : ''}`} 
          onClick={() => setCurrentSection('hisobot')}
        >
          📊 Hisobotlar
        </div>
        <div 
  ...
  // Include the power of attorney button in your main content render
  const renderContent = () => {
    return (
  ...
  // Make sure to add the power of attorney modal to your main component return
  return (
      ...
      <div className="yurist-content">
        <div className="yurist-header">
          <h2>{
            ...
            currentSection === 'hisobot' ? 'Hisobotlar' :
            'Tugatilgan ishlar'
          }</h2>
