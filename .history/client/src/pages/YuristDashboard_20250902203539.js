...
function YuristDashboard({ onLogout }) {
  ...
  const fetchStatistics = useCallback(async () => {
    try {
  const res = await apiFetch('/api/statistics/lawyer');
  ...
  const handleAcceptTask = async () => {
    ...
    try {
      ...
      const res = await apiFetch(`/api/job-actions/${selectedTask._id}/accept-by-lawyer`, {
        method: 'POST',
  ...
  const handleCompleteTask = async () => {
    ...
    try {
      ...
      const res = await apiFetch(`/api/job-actions/${selectedTask._id}/complete-by-lawyer`, {
        method: 'POST',
        headers: {},
        body: formData
      });
  ...
  const handleUploadCertificates = async (jobId, file) => {
    ...
    try {
      const res = await apiFetch(`/api/jobs/${jobId}/upload-certificates`, {
        method: 'POST',
        headers: {},
        body: formData,
      });
  ...
  const saveInvoiceAndNotifyClient = async () => {
    ...
    try {
      const res = await apiFetch(`/api/job-actions/${selectedTask._id}/send-invoice`, {
        method: 'POST',
        headers: {},
        body: formData
      });
  ...
  const saveDocuments = async () => {
    ...
    try {
      const res = await apiFetch(`/api/job-actions/${selectedTask._id}/save-lawyer-docs`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          documentData: {
