...
import Tasks from './components/Tasks'; // Import qilingan
...
function AdminDashboard() {
  ...
  const handleSubmitJob = async (e) => {
    ...
    try {
      ...
      // Bu yerda Tasks komponentini qayta yuklash kerak bo'ladi,
      // lekin hozircha bu qism Tasks ichida mustaqil ishlaydi.
    } catch (err) {
      alert(err.message);
    }
  };
