...
function TekshiruvchiDashboard() {
  ...
  }, [token, currentSection]); // currentSection qo'shildi
  ...
  // SidebarTekshiruvchi komponentiga ko'rib chiqilgan ishlar bo'limini qo'shish
  return (
  ...
  // renderContent funksiyasiga ko'rib chiqilgan ishlar bo'limini qo'shish
  const renderContent = () => {
    switch (currentSection) {
      ...
      case 'korib_chiqilgan':  // Yangi bo'lim
        return (
          <div className="dashboard-content">
