...
function OperatorDashboard({ onLogout }) {
  ...
  // Brendni tekshiruvchiga yuborish - Use the new utility function
  const sendBrandForReview = async () => {
    ...
    try {
      ...
      if (!classesSaved) {
        throw new Error('MKTU sinflarini saqlashda xatolik yuz berdi');
      }
  ...
  // Hujjatlarni saqlash va tekshiruvchiga yuborish - Use the new utility function
