...
function YuristDashboard({ onLogout }) {
  ...
  const renderModal = () => {
    ...
    const hasPowerOfAttorney = selectedTask.documents && 
                              Array.isArray(selectedTask.documents) && 
                              selectedTask.documents.some(d => d.type === 'power-of-attorney');
    
    console.log('Ishonchnoma mavjud:', hasPowerOfAttorney);
    console.log('Documents:', selectedTask.documents);
              ...
              <div className="info-card brand-card">
                ...
                <div className="info-card-body">
                  <div className="info-row">
                    ...
                    <span className="info-value">{selectedTask.brandName}</span>
                  </div>
                  {selectedTask.classes && Array.isArray(selectedTask.classes) && selectedTask.classes.length > 0 && (
                    <div className="info-row">
                      ...
                      <span className="info-value">{selectedTask.classes.join(', ')}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              {hasPowerOfAttorney ? (
                <div className="power-of-attorney-block">
                  ...
                  <div className="power-of-attorney-content">
                    ...
                    {selectedTask.documents.filter(d => d.type === 'power-of-attorney').map((doc, index) => (
                      <div key={index} className="poa-document">
                        <span className="poa-document-label">
                          ...
                          {selectedTask.documents.filter(d => d.type === 'power-of-attorney').length > 1 ? ` #${index+1}` : ''}
                        </span>
                        <button 
                ...
                <div className="power-of-attorney-missing-block">
                  ...
                  <div className="power-of-attorney-missing-content">
                    <div className="poa-badge missing">⚠️ Ishonchnoma mavjud emas</div>
                  </div>
                </div>
              )}
