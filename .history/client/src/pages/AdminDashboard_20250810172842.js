...
function AdminDashboard() {
  ...
  return (
    <div className="operator-admin-wrapper">
      {/* Sidebar o'rniga to'g'ridan-to'g'ri JSX */}
      <aside className="sidebar-admin">
        ...
        <ul className="sidebar-list">
          ...
          <li className={current === 'ishlar' ? 'active' : ''} onClick={() => setCurrent('ishlar')}>
            <span role="img" aria-label="ishlar">📋</span> Ishlar
          </li>
          <li className={current === 'operator' ? 'active' : ''} onClick={() => setCurrent('operator')}>
            <span role="img" aria-label="operator">👨‍💼</span> Operatorlar
          </li>
          <li className={current === 'tekshiruvchi' ? 'active' : ''} onClick={() => setCurrent('tekshiruvchi')}>
            <span role="img" aria-label="tekshiruvchi">🔎</span> Tekshiruvchilar
          </li>
          <li className={current === 'yurist' ? 'active' : ''} onClick={() => setCurrent('yurist')}>
            <span role="img" aria-label="yurist">⚖️</span> Yuristlar
          </li>
