...
function YuristDashboard({ onLogout }) {
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      // Qo'shimcha filtr parametrlari qo'shish
      const queryParams = new URLSearchParams();
      queryParams.append('status', status);
      
      // Qo'shimcha: sana bo'yicha filtrlash uchun
      if (dateFilter?.from) {
  ...
  }, [token, selectedSection, dateFilter, searchQuery]);
  ...
  useEffect(() => {
    fetchProfile();
    fetchTasks();
    fetchStatistics(); // Statistikani ham yuklash
  }, [token, fetchTasks, fetchProfile, fetchStatistics]);
    ...
    return (
      <div className="modal">
        <div className="modal-content">
          ...
          {/* Yurist ma'lumotlarini ko'rsatish */}
          {selectedTask.lawyerNotes && (
            <div className="lawyer-notes">
              <h4>Yurist qaydlari</h4>
              <div className="notes-content">{selectedTask.lawyerNotes}</div>
            </div>
          )}
    ...
    <div className="yurist-dashboard">
      ...
      <div className="yurist-content">
        ...
        <div className="search-filters">
          ...
          />
          <button onClick={fetchTasks} className="search-button">Izlash</button>
        </div>
