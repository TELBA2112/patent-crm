...
function OperatorDashboard({ onLogout }) {
  ...
  const menuItems = [
    ...
    { key: 'yangi', icon: '🟦', label: 'Yangi mijozlar' },
    { key: 'jarayonda', icon: '🟨', label: 'Jarayonda' },
    { key: 'tugatilgan', icon: '✅', label: 'Tugatilgan' },
    { key: 'logout', icon: '🚪', label: 'Chiqish' }
  ];
