                  ...
                  <div className="document-content">
                    ...
                    {doc.personType === 'jismoniy' && doc.jismoniyDocs && (
                      <div className="jismoniy-details">
                        ...
                        {/* Updated to show both front and back passport images */}
                        {doc.jismoniyDocs.passportImageFront && (
                          <div className="document-image">
                            <p>Pasport old qismi:</p>
                            <img src={doc.jismoniyDocs.passportImageFront} alt="Pasport old qismi" width="100" />
                          </div>
                        )}
                        ...
                        {doc.jismoniyDocs.passportImageBack && (
                          <div className="document-image">
                            ...
                            <img src={doc.jismoniyDocs.passportImageBack} alt="Pasport orqa qismi" width="100" />
                          </div>
                        )}
